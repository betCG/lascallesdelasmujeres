...
function Constants(){
    ...
    this.countriesList = [
        ...
        {id: 'costarica', name: 'Costa Rica', citiesList:[
          {id: 'alajuela', name: 'Alajuela', datos: {numLink:8,pcLink:30.8,numNoLink:18,pcNoLink:69.2,numMale:38,numFemale:26,pcMale:59.4,pcFemale:40.6,totalNames:64}, center: [-84.198235,10.009604]},
          {id:'heredia', name:'Heredia', datos: {numLink:8,pcLink:28.6,numNoLink:20,pcNoLink:71.4,numMale:59,numFemale:28,pcMale:67.8,pcFemale:32.2,totalNames:87}, center:[-84.1191,9.998745]},
